...
<Prüfung von Architekturentscheidungen, MCP-Konventionen, FastMCP-Tools, Argumenten, API-Mappings, Fehlerbehandlung, API-Mocks, Vikunja-Integration und vorhandenen Patterns.>
...
<Prüfung von Statuswerten, Rollenregeln, Zugriffsschutz (Vikunja-API-Token) und Mehrpersonen-Koordination.>
