...
- vorhandene Test-Strukturen und pytest-Konventionen
...
|---|---|---|
| MCP Server (FastMCP) | genutzt / nicht genutzt / teilweise | |
| HTTP-Client (httpx) | genutzt / nicht genutzt / teilweise | |
| pytest | genutzt / nicht genutzt / teilweise | |

**Demo-Inhalte, die für dieses Projekt nicht relevant sind:**

- [ ] Demo MCP-Tools in server.py (z.B. `set_reminders`, `list_labels`)
- [ ] Demo-Tests in `tests/`
